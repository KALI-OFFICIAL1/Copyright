...
DEVS = [6908972904]  # এটা list হিসেবে রাখা উচিত, user ids integer
BOT_USERNAME = "silent_copyright_bot"  # @ ছাড়া
...
BLACKLIST_WORDS = [
    "mc", "madarchod", "randi", "sex", "xxx", "gand", "lund", "land",
    "mc", "bc", "bhenchod", "chut", "lawda", "gandu", "spam", "fuck", "shit"
]
...
async def enable_disable(bot, message: Message):
    chat = message.chat
    ...
    if txt:
        if re.search(r"on|yes|enable", txt.lower()):
        ...
        elif re.search(r"no|off|disable", txt.lower()):
